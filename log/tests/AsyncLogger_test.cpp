...
void bench1(AsyncLoggerPtr logger, bool longLog) {
	...
	for (int t = 0; t < 30; ++t) {
		...
		for (int i = 0; i < kBatch; ++i) {
			DLOG_INFO(logger) << "Hello 0123456789" << " abcdefghijklmnopqrstuvwxyz "
...
void bench2(AsyncLoggerPtr logger, bool longLog) {
